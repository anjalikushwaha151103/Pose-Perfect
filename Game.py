...
pygame.init()
icon = pygame.image.load(r'Images\clock.png')
...
#fonts
marcellus = r"Fonts\Marcellus-Regular.ttf"
silkscreen = r"Fonts\Silkscreen-Regular.ttf"
nabla = r"Fonts\Nabla.ttf"
gow = r"Fonts\god-of-war.ttf"
...
#Images
bg1 = pygame.image.load(r'Background_Images\pose perfect.png').convert_alpha()
bg1 = pygame.transform.scale(bg1,(width,height))
bg2 = pygame.image.load(r'Background_Images\pose perfect.png').convert_alpha()
bg2 = pygame.transform.scale(bg2,(width,height))
bg3 = pygame.image.load(r'Background_Images\pose perfect.png').convert_alpha()
bg3 = pygame.transform.scale(bg3,(width,height))
bg4 = pygame.image.load(r'Background_Images\pose perfect.png').convert_alpha()
...
title = pygame.image.load(r'Background_Images\pose perfect.png').convert_alpha()
title = pygame.transform.scale(title, (600,600))
title_with_man = pygame.image.load(r'Background_Images\pose perfect.png').convert_alpha()
excluded_poses = ["Crossed Arms", "Dribbling", "Pushing", "Salute"]
filtered_label = [pose for pose in label if pose not in excluded_poses]
poseImages = {i: pygame.transform.scale(pygame.image.load(r"poseImages\{}.png".format(i)).convert_alpha(), (370, 250)) for i in filtered_label}

gameover = pygame.image.load(r"Images\gameover3.png").convert_alpha()
